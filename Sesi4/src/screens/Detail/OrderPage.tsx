...
const OrderPage: React.FC<OrderPageProps> = () => {
  const navigation =
    useNavigation<StackNavigationProp<RootStackParamList, 'OrderPage'>>();
  const route = useRoute<RouteProp<RootStackParamList, 'OrderPage'>>();
    ...
    <View style={styles.container}>
      ...
      <View style={styles.addressContainer}>
        ...
        <Text style={styles.subAddress}>
          Kp. Cikukulu Rt.18 Rw.05 Des.Cisande Kec.Cicantayan Kab.Sukabumi
          Jawabarat.
        </Text>
