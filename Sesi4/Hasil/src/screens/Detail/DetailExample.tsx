    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Image source={liked ? require('../../../assets/Hati.png') : require('../../../assets/Hati.png')}
            ...
            <View style={styles.ratingContainer}>
                <Image source={require("../../../assets/Bintang.png")} style={styles.iconSmall} />
                <Text style={styles.rating}>{rating}</Text>
                <Text style={styles.ratingCount}>(230)</Text>
                <Image source={require("../../../assets/bean.png")} style={styles.iconSmall} />
                <Image source={require("../../../assets/susu.png")} style={styles.iconSmall} />
            </View>
